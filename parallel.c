...
void calculate_forces1(struct particle *p, struct particle *f, float *m, int n)
{ // 
...
void calculate_forces2(struct particle *p, struct particle *f, float *m, int n)
{ // атомарные операции
...
void calculate_forces3(struct particle *p, struct particle *f, float *m, int n)
{ // N блокировок
	#pragma omp for schedule(dynamic, 4) nowait
	for (int i = 0; i < n - 1; i++)
	{
...
void calculate_forces4(struct particle *p, struct particle *f, float *m, int n)
...
void calculate_forces5(struct particle *p, struct particle *f[], float *m, int n)
